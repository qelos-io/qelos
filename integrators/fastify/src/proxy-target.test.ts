...
describe('resolveQelosProxyTarget', () => {
  ...
  it('returns undefined when nothing is configured', () => {
    const config: QelosFastifyConfig = { appUrl: '' };
