...
describe('Duplicate Checker Integration', () => {
  ...
  describe('Manual duplicate detection', () => {
    it('should manually detect duplicates in blueprint files', () => {
      ...
      assert.strictEqual(duplicates[0].identifier, 'test-bp');
      assert.deepStrictEqual(duplicates[0].files, [file1, file2]);
    });
    ...
    it('should manually detect duplicates in config files', () => {
      ...
      assert.strictEqual(duplicates.length, 1);
      assert.strictEqual(duplicates[0].identifier, 'test-config');
    });
    ...
    it('should manually detect duplicates in plugin files', () => {
      ...
      assert.strictEqual(duplicates.length, 1);
      assert.strictEqual(duplicates[0].identifier, '/test-plugin');
    });
    ...
    it('should handle multiple duplicate groups', () => {
      ...
      assert.strictEqual(duplicates[0].identifier, 'group1');
      assert.strictEqual(duplicates[1].identifier, 'group2');
    });
  });
});
