...
const selector = 'p, h1, h2, h3, h4, h5, h6, div, remove-confirmation, block-item, empty-state, ai-chat, button, select, textarea, el-button, el-select, el-input, el-form, form, life-cycle';
