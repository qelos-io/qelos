...
import { IGithubSource, IntegrationSourceKind } from '@qelos/global-types';
import { watch } from 'vue';
import { ref, defineProps, defineEmits } from 'vue';

const props = defineProps({
  modelValue: {
    type: Object as () => IGithubSource,
  },
});

const emit = defineEmits(['update:modelValue', 'submit', 'close']);

const formModel = ref({ ...props.modelValue, kind: IntegrationSourceKind.GitHub });
...
watch(() => props.modelValue, (newValue) => {
  formModel.value = { ...newValue, kind: IntegrationSourceKind.GitHub };
