...
import { createEvent, getAllEvents, getEvent, getEventsCount, getEventsSum, getFilterOptions } from '../controllers/events';
...
eventsRouter
  ...
  .get('/api/events/filter-options', AUTHENTICATION_MIDDLEWARES.concat(getFilterOptions))
